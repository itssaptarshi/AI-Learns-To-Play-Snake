...
class Agent:
    ...
    def get_state(self,game):
        ...
        state = [
            ...
            (dir_l and game.is_colission(point_l)) or
            (dir_u and game.is_colission(point_u)) or
            (dir_d and game.is_colission(point_d)),

            #danger right
            (dir_u and game.is_colission(point_r)) or
            (dir_d and game.is_colission(point_l)) or
            (dir_l and game.is_colission(point_u)) or
            (dir_r and game.is_colission(point_d)),

            #danger left
            (dir_d and game.is_colission(point_r)) or
            (dir_u and game.is_colission(point_l)) or
            (dir_r and game.is_colission(point_u)) or
